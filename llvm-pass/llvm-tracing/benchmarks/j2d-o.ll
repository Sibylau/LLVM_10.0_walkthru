...
for.cond:                                         ; preds = %for.end87, %entry
  %t.0 = phi i32 [ 0, %entry ], [ %inc89, %for.end87 ]
  %exitcond16 = icmp ne i32 %t.0, 100
...
for.body6:                                        ; preds = %for.cond4
  ...
  %arrayidx12 = getelementptr inbounds [20 x i32], [20 x i32]* %arrayidx, i64 0, i64 %1
  ...
  %add18 = add nsw i32 %add, %3
  %4 = add nuw nsw i64 1, %indvars.iv2
  %arrayidx21 = getelementptr inbounds [20 x [20 x i32]], [20 x [20 x i32]]* @main.A, i64 0, i64 %4
  %arrayidx23 = getelementptr inbounds [20 x i32], [20 x i32]* %arrayidx21, i64 0, i64 %indvars.iv
  %5 = load i32, i32* %arrayidx23, align 4
  %add24 = add nsw i32 %add18, %5
  %6 = sub nuw nsw i64 %indvars.iv2, 1
  %arrayidx27 = getelementptr inbounds [20 x [20 x i32]], [20 x [20 x i32]]* @main.A, i64 0, i64 %6
  %arrayidx29 = getelementptr inbounds [20 x i32], [20 x i32]* %arrayidx27, i64 0, i64 %indvars.iv
  %7 = load i32, i32* %arrayidx29, align 4
  %add30 = add nsw i32 %add24, %7
...
for.body46:                                       ; preds = %for.cond43
  ...
  %8 = load i32, i32* %arrayidx50, align 4
  %9 = sub nuw nsw i64 %indvars.iv7, 1
  %arrayidx55 = getelementptr inbounds [20 x i32], [20 x i32]* %arrayidx48, i64 0, i64 %9
  %10 = load i32, i32* %arrayidx55, align 4
  %add56 = add nsw i32 %8, %10
  %indvars.iv.next8 = add nuw nsw i64 %indvars.iv7, 1
  %arrayidx61 = getelementptr inbounds [20 x i32], [20 x i32]* %arrayidx48, i64 0, i64 %indvars.iv.next8
  %11 = load i32, i32* %arrayidx61, align 4
  %add62 = add nsw i32 %add56, %11
  %12 = add nuw nsw i64 1, %indvars.iv11
  %arrayidx65 = getelementptr inbounds [20 x [20 x i32]], [20 x [20 x i32]]* @main.B, i64 0, i64 %12
  %arrayidx67 = getelementptr inbounds [20 x i32], [20 x i32]* %arrayidx65, i64 0, i64 %indvars.iv7
  %13 = load i32, i32* %arrayidx67, align 4
  %add68 = add nsw i32 %add62, %13
  %14 = sub nuw nsw i64 %indvars.iv11, 1
  %arrayidx71 = getelementptr inbounds [20 x [20 x i32]], [20 x [20 x i32]]* @main.B, i64 0, i64 %14
  %arrayidx73 = getelementptr inbounds [20 x i32], [20 x i32]* %arrayidx71, i64 0, i64 %indvars.iv7
  %15 = load i32, i32* %arrayidx73, align 4
  %add74 = add nsw i32 %add68, %15
